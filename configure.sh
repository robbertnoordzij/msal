...
server.max-http-header-size=${MAX_HTTP_HEADER_SIZE:-48KB}
...
app.azure-ad.credential-type=${AZURE_CREDENTIAL_TYPE:-secret}
app.azure-ad.managed-identity-client-id=${AZURE_MANAGED_IDENTITY_CLIENT_ID:-}
